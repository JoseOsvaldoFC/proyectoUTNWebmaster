        ...
        <section class="loginImagen container-fluid" data-type="parallax" data-speed="10">
          ...
          <!-- Contenido -->
                  <div  class="cajas text-center">
                    <form method="post" action="inicioPagina.php" target="_blank">
                      <!-- Campo Nombre -->
                      <div class="form-group pt-5">
                        <label for="Usuario">Usuario</label>
                        <input type="text" class="form-control" id="Usuario" placeholder="Usuario" required="true">
                      </div>
                      <div class="form-group">
                        <label for="Contraseña">Contraseña</label>
                        <input type="password" class="form-control" id="Contraseña" placeholder="Contraseña"  required="true">
                      </div>
                      <div class="form-group">
                        <div class="pb-5">
